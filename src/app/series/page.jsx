import { tmdbSeriesURL } from '@/utils';
...
const Series =async ({searchParams}) => {
   ...
   const data = await fetchMovies(tmdbSeriesURL, page);
  ...
  return (
    ...
    <div className="px-2 py-4">
      ...
      <div className="flex justify-center w-1/2 md:w-3/12 mx-auto items-center  ">
        {/* Previous Button */}
        {currentPage > 1 && (
          <Link href={`/series?page=${currentPage - 1}`} className="mx-auto bg-green-500 hover:bg-green-700 text-black px-4 py-2">
            Previous
          </Link>
        )}
